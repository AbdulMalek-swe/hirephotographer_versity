...
import img1 from 'assets/unnamed.jpeg'
const Home = () => {
        ...
        <div>
          ...
          <ShareScreenShort/>
              <div className='flex flex-wrap items-center justify-center'>
                {
                  photo.slice(0,12).map(item=><div className='mx-3 my-2'>
                    <img src={item.thumbnailUrl} alt='loading' width="150px" height="150px"/>
                  </div>)
                }
              </div>
              <Faq/>
            ...
            <div className='grid md:grid-cols-2 grid-cols-1'>
                <div>
                    ...
                    <div className='mt-[88px]'>
                            <img src={img1} className='w-full h-[288px] object-contain' alt='loading'/>
                        </div>
                </div>
                <div>
                <div className='mx-[40px] '>
                            <img src={img1} className='w-full h-[515px] object-contain' alt='loading' />
                        </div>
                </div>
            </div>
        </div>
